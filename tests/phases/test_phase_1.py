...
def test_phase_1_exit_criterion() -> None:
    ...
    TODO(phase 1): replace this placeholder with a real assertion for the
    criterion above once Phase 1 is implemented. Until then it must stay red.
    """
    pytest.fail("Phase 1 (Basic AI chat) not yet implemented.")
